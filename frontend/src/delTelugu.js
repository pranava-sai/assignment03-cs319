...
function DeleteTeluguMovie() {
    ...
    const handleSubmit = async (event) => {
        ...
        const url = `http://127.0.0.1:8081/deleteTelugu/${movieId}`;
    ...
    return (
        <form onSubmit={handleSubmit}>
                <input type="text" value={movieId} onChange={handleChange} placeholder='Enter Movie ID' required />
            <br /><br />
            <button type="submit">Delete Telugu Movie</button>
        </form>
    );
}

export default DeleteTeluguMovie;
