...
function DeleteHindiMovie() {
    ...
    const handleSubmit = async (event) => {
        ...
        const url = `http://127.0.0.1:8081/deleteHindi/${movieId}`;
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(`Failed to delete Hindi movie: ${errorText}`);
            }
    ...
    <button type="submit">Delete Hindi Movie</button>
</form>
    );
}

export default DeleteHindiMovie;
