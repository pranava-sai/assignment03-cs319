...
function UpdateEnglishMovie() {
    ...
    const handleSubmit = async (event) => {
        ...
        const url = `http://127.0.0.1:8081/updateEnglish/${formData.id}`;
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(`Failed to update English movie: ${errorText}`);
            }
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" name="image" value={formData.url} onChange={handleChange} placeholder='Image URL' required /><br /><br />
